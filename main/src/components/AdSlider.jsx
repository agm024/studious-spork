...
const slides = [
  {
    ...
    eyebrow: "Farm Fresh",
    headline: "Seasonal Produce Offers Up To 30% Off",
    sub: "Get handpicked fruits, vegetables, and kitchen essentials from trusted suppliers.",
    cta: "Shop Produce",
    to: "/products",
    badge: "Fresh Today",
  },
  {
    ...
    headline: "Best Prices On Grains, Pulses And Flours",
    sub: "Stock your pantry with quality staples at savings for every household.",
    cta: "Explore Staples",
    to: "/products",
    badge: "Limited Deal",
  },
